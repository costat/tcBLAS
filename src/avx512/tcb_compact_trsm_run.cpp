...
#undef DOUBLE
#define SINGLE
#define F_NAME tcb_compact_trsm_runn_avx512_f32
#include "tcb_compact_trsm_lln_run_core.cxx"
#undef F_NAME

#undef SINGLE
#define DOUBLE
#define F_NAME tcb_compact_trsm_runn_avx512_f64
#include "tcb_compact_trsm_lln_run_core.cxx"
#undef F_NAME
...
#undef DOUBLE
#define SINGLE
#define F_NAME tcb_compact_trsm_runu_avx512_f32
#include "tcb_compact_trsm_lln_run_core.cxx"
#undef F_NAME

#undef SINGLE
#define DOUBLE
#define F_NAME tcb_compact_trsm_runu_avx512_f64
#include "tcb_compact_trsm_lln_run_core.cxx"
#undef F_NAME
