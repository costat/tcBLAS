...
#undef DOUBLE
#define SINGLE
#define F_NAME tcb_compact_trsm_llnn_avx2_f32
#include "tcb_compact_trsm_lln_run_core.cxx"
#undef F_NAME

#undef SINGLE
#define DOUBLE
#define F_NAME tcb_compact_trsm_llnn_avx2_f64
#include "tcb_compact_trsm_lln_run_core.cxx"
#undef F_NAME
...
#undef DOUBLE
#define SINGLE
#define F_NAME tcb_compact_trsm_llnu_avx2_f32
#include "tcb_compact_trsm_lln_run_core.cxx"
#undef F_NAME

#undef SINGLE
#define DOUBLE
#define F_NAME tcb_compact_trsm_llnu_avx2_f64
#include "tcb_compact_trsm_lln_run_core.cxx"
#undef F_NAME
